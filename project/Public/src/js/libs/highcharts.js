...
(function(){
  Highcharts.theme = {
    ...
    chart: {
    	style: {
    		fontFamily: '"微软雅黑", "Microsoft Yahei", "Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif'
    	}
    },
    colors: ["#5dc1f7", "#fe8f02", "#2c86f2", "#87d731", "#fd392a"],
    xAxis: {
      gridLineColor: '#e7f5fb',
      gridLineWidth: 1,
      minorGridLineColor: '#e7f5fb',
      minorGridLineWidth: 1,
      minorTickInterval: null,
      lineWidth: 1,
      lineColor: '#e7f5fb',
    ...
    legend: {
      ...
      //verticalAlign: 'top',
      itemStyle: {
        font: '9pt "微软雅黑", "Microsoft Yahei", "Helvetica Neue", Helvetica, Arial, sans-serif',
        color: '#666666'
      },
      itemHoverStyle: {
        color: '#3c69a0'

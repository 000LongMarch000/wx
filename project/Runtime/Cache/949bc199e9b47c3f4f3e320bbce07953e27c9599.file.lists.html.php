<?php /* Smarty version Smarty-3.1.6, created on 2015-10-05 15:07:22
         compiled from "/usr/share/nginx/wx/project/Application/Admin/View/Product/lists.html" */ ?>
<?php /*%%SmartyHeaderCode:116653888561218696988b7-02047817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '949bc199e9b47c3f4f3e320bbce07953e27c9599' => 
    array (
      0 => '/usr/share/nginx/wx/project/Application/Admin/View/Product/lists.html',
      1 => 1444028302,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '116653888561218696988b7-02047817',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_561218698a973',
  'variables' => 
  array (
    'assets_path' => 0,
    'DEBUG' => 0,
...
<?php if ($_valid && !is_callable('content_561218698a973')) {function content_561218698a973($_smarty_tpl) {?><?php if (!is_callable('smarty_function_autover')) include '/usr/share/nginx/wx/ThinkPHP/Library/Vendor/Smarty/plugins/function.autover.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../Common/side_nav/product.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '116653888561218696988b7-02047817');
content_561221aa90dd5($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../Common/side_nav/weixin.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '116653888561218696988b7-02047817');
content_561221aa93a62($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../Common/side_nav/user.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '116653888561218696988b7-02047817');
content_561221aa96101($_smarty_tpl);
    ...
    <div class="search-bar search-bar-upper">
      <form action="/admin/product/lists/search/y" method="get">
        <select name="f" class="wgt-select" width="100">
            <option value="id" <?php if ($_smarty_tpl->tpl_vars['field']->value=='id'){?> selected <?php }?>>商品编号</option>
        </select>
...
">
          <td><div class="cell">
              <a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['product_url'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
</a>
          </div></td>
          <td><div class="cell">
...
" target="_blank">查看</a>
          ...
          <td><div class="cell">
               <?php echo $_smarty_tpl->tpl_vars['item']->value['platform'];?>

          </div></td>
          <td><div class="cell">
               <?php echo $_smarty_tpl->tpl_vars['item']->value['visits'];?>

          </div></td>
          <td><div class="cell">
              <?php if ($_smarty_tpl->tpl_vars['item']->value['user']['id']){?>
              <?php echo $_smarty_tpl->tpl_vars['item']->value['user']['id'];?>
(<?php if ($_smarty_tpl->tpl_vars['item']->value['user']['level']=='2'){?>银牌<?php }elseif($_smarty_tpl->tpl_vars['item']->value['user']['level']=='3'){?>金牌<?php }else{ ?>暂无<?php }?>)
              <?php }?>
          </div></td>
          <td><div class="cell">
          ...
          <td><div class="cell opts">
            <a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['product_url'];?>
" target="_blank">查看</a>
            <a href="/admin/product/edit/id/<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">编辑</a>
          </div></td>
        </tr>
        <?php } ?>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.6, created on 2015-10-05 15:07:22
         compiled from "/usr/share/nginx/wx/project/Application/Admin/View/Common/side_nav/product.html" */ ?>
<?php if ($_valid && !is_callable('content_561221aa90dd5')) {function content_561221aa90dd5($_smarty_tpl) {?><div class="side-navs">
  <div class="nav-sec">
    <div class="hd">
...
<?php if ($_valid && !is_callable('content_561221aa93a62')) {function content_561221aa93a62($_smarty_tpl) {?><div class="side-navs">
  <div class="nav-sec">
    <div class="hd">
...
<?php if ($_valid && !is_callable('content_561221aa96101')) {function content_561221aa96101($_smarty_tpl) {?><div class="side-navs">
  <div class="nav-sec">
    <div class="hd">
